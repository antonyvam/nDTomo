...
This section contains Jupyter notebook examples demonstrating how to use nDTomo.

.. toctree::
   :maxdepth: 1

   notebooks/tutorial_phantoms.ipynb
   ...
   notebooks/tutorial_dimensionality_reduction.ipynb
   ...
   notebooks/tutorial_segmentation.ipynb
