...
(3) Creation of demonstration scripts for (a) integration of XRD-CT data as well as for (b) processing and correcting sinograms and radiographs for X-ray computed tomography data for various artefacts
