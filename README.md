...
| [`tutorial_segmentation.ipynb`](https://github.com/antonyvam/nDTomo/blob/master/docs/source/notebooks/tutorial_segmentation.ipynb) | Image segmentation in CPU and GPU |
